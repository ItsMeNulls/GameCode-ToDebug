...
Window_FriendshipLeaders.prototype.drawItem = function(index) {
    ...
    if (this._data[index] !== 0) {
      ...
      this.drawActorCharacterFace(actor, this.textPadding() / 2, rect.y);
...
Window_Base.prototype.drawActorCharacterFace = function(actor, x, y) {
    this.drawCharacterFace(actor.characterName(), actor.characterIndex(), x, y);
};

Window_Base.prototype.drawCharacterFace = function(characterName, characterIndex, x, y) {
    var bitmap = ImageManager.loadCharacter(characterName);
    this.contents.blt(bitmap, 48, 22, 32, 32, x, y);
};
...
Window_ActorsFriendship.prototype.drawFriendshipLevelText = function(index) {
    ...
    var rect = this.itemRect(index);
    var wx = rect.x + 550 + Moogle_X.AFS.fpLvlTextOffsetX;
...
Window_ActorsFriendship.prototype.drawFriendshipLevelNumber = function(index) {
    ...
    var rect = this.itemRect(index);
    var wx = rect.x + 745 + Moogle_X.AFS.fpLvlNumberOffsetX;
...
Window_ActorsFriendship.prototype.drawCurrentFpText = function(index) {
    ...
    var rect = this.itemRect(index);
    var wx = rect.x + 700 + Moogle_X.AFS.currentFpTextOffsetX;
...
Window_ActorsFriendship.prototype.drawCurrentFpNumber = function(index) {
    ...
    var rect = this.itemRect(index);
    var wx = rect.x + 995 + Moogle_X.AFS.currentFpNumberOffsetX;
    var wy = rect.y + Moogle_X.AFS.currentFpNumberOffsetY;
...
Window_ActorsFriendship.prototype.drawNextLevelText = function(index) {
    ...
    var rect = this.itemRect(index);
    var wx = rect.x + 800 + Moogle_X.AFS.nextLevelTextOffsetX;
    var wy = rect.y + Moogle_X.AFS.nextLevelTextOffsetY;
...
Window_ActorsFriendship.prototype.drawNextLevelNumber = function(index) {
    ...
    var rect = this.itemRect(index);
    var wx = rect.x + 1045 + Moogle_X.AFS.nextLevelNumberOffsetX;
    var wy = rect.y + Moogle_X.AFS.nextLevelNumberOffsetY;
