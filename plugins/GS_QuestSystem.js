 ...
 * @default #ff0000
 *
 * @param Complete Quest Color
 * @desc Color for Completed Quests in Hex
 * @default #00ff00
 *
 * @param Failed Quest Color
 * @desc Color for Failed Quests in Hex
 * @default #ff0000
 *
...
//---------------------------------------------------------------------------------------------
    ...
    Window_Quests.prototype.drawItem = function(index) {
        ...
        if (item.symbol === "quest") {
            ...
            switch(q.status){
                case "failed":
                    this.changeTextColor(GSScripts["Config"]["QuestSystem"]["Failed Quest Color"] || this.systemColor());
                    break;
                case "completed":
                    this.changeTextColor(GSScripts["Config"]["QuestSystem"]["Complete Quest Color"] || this.systemColor());
                    break;
                case "default":
                default:
                    this.changeTextColor(GSScripts["Config"]["QuestSystem"]["Quest Name Color"] || this.systemColor());
                    break;
            }
        }
