 ...
 *
 * @help
 * Script Call to access this menu:
 * SceneManager.push(PivertAchievements);
 *
 ...
 *
 *
 * ICF-Soft Mod for preload manager compatibility
 *
 */

var PivertAchievements = (function () {
    ...
    var prepareAchievements = function (xhr) {
        try {
		...
		window.setTimeout(function (xhr) {
		    if (xhr) prepareAchievements(xhr);
		},50,xhr);
        }
    };
