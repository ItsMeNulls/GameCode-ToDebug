...
//============================================================
L2DBaseModel.prototype.loadModelData = function (modelSetting, path/*String*/, gl, callback) {
    /*
    ...
    */
    ...
    var thisRef = this;
    pm.loadLive2DModel(modelSetting, path, gl, function (l2dModel) {
        thisRef.live2DModel = l2dModel;
        if (l2dModel._cubismVersion !== 3) {
...
L2DViewMatrix.prototype.changeScale = function (scale, flip) {
    scale = Math.max(Math.min(scale, this.max), this.min);
    this.tr[0] = flip ? -scale : scale;
    this.tr[5] = scale;
    return scale;
}
