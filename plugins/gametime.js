...
(function() {
	...
	var yearPost = (parameters['Year Post'] || "");
	...
	Window_GameTime.prototype.refresh = function() {
		...
		if(this.getFormat() == "full") {
			...
			if(menuTime && SceneManager._scene.inMenu()) {
			this.drawText(clockText,0,0,this.contents.width,0);}
			else {
				this.drawText(clockText,40,0,this.contents.width,0);
			}
	}
